...
class PortfolioFooter extends StatelessComponent {
  final String classes;

  const PortfolioFooter({super.key, this.classes = 'sidebar-footer'});
  ...
  Component build(BuildContext context) {
    return footer(classes: classes, [
      div(classes: 'social-links', [
        a(
          href: PortfolioData.mailtoUrl,
          attributes: {'aria-label': 'Email'},
          classes: 'social-icon-btn',
          [
            RawText(
        ...
        a(
          ...
          target: Target.blank,
          attributes: {'aria-label': 'LinkedIn', 'rel': 'noopener noreferrer'},
          classes: 'social-icon-btn',
          [
            RawText(
              '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14m-.5 15.5v-5.3a3.26 3.26 0 0 0-3.26-3.26c-.85 0-1.84.52-2.28 1.3v-1.11h-2.79v8.37h2.79v-4.93c0-.77.62-1.4 1.39-1.4a1.4 1.4 0 0 1 1.4 1.4v4.93h2.75M6.88 8.56a1.68 1.68 0 0 0 1.68-1.68c0-.93-.75-1.69-1.68-1.69a1.69 1.69 0 0 0-1.69 1.69c0 .93.76 1.68 1.69 1.68m1.39 9.94v-8.37H5.5v8.37h2.77z"/></svg>',
            ),
          ],
        ),
        a(
          ...
          target: Target.blank,
          attributes: {'aria-label': 'YouTube', 'rel': 'noopener noreferrer'},
          classes: 'social-icon-btn',
          [
            RawText(
        ...
        a(
          ...
          target: Target.blank,
          attributes: {'aria-label': 'Instagram', 'rel': 'noopener noreferrer'},
          classes: 'social-icon-btn',
          [
            RawText(
      ...
      a(
        ...
        target: Target.blank,
        classes: 'resume-download-btn',
        attributes: {'download': 'Firdous_Ismail_Resume.pdf'},
        [
          RawText(
      ...
      p(classes: 'copyright', [
        .text('© 2026 Firdous Ismail. Built with Jaspr.'),
      ]),
    ]);
  }
}
